...
<div class="page">
    ...
    <div class="page__bd page__bd_spacing">
        <div class="weui-grids" id="originMicroservice">
            <a href="javascript:;" class="weui-grid" id="TonzhiGongGao" <c:if test="${features.tonzhiGongGao=='true'}">style="display:none"</c:if>>
                <div class="weui-grid__icon">
                    <img src="/static/images/icon_nav_dialog.png" alt="">
                </div>
                <p class="weui-grid__label">通知公告</p>
            </a>
            <a href="javascript:;" class="weui-grid" id="XingZhengQuHua" <c:if test="${features.minzhengDongTai=='true'}">style="display:none"</c:if> >
                <div class="weui-grid__icon">
            ...
            <a href="javascript:;" class="weui-grid" id="YouDaiFuXu" <c:if test="${features.youDaiFuXu=='true'}">style="display:none"</c:if>>
                <div class="weui-grid__icon">
            ...
            <a href="${url.wangShangBanShiUrl}" class="weui-grid" <c:if test="${features.wangshangBanshi=='true'}">style="display:none"</c:if>>
                <div class="weui-grid__icon">
            ...
            <a href="javascript:;" class="weui-grid" id="MinzhengKanWu" <c:if test="${features.minzhengKanWu=='true'}">style="display:none"</c:if>>
                <div class="weui-grid__icon">
            ...
            <a href="javascript:;" class="weui-grid" id="TuiWuAnZhi" <c:if test="${features.tuiWuAnZhi=='true'}">style="display:none"</c:if>>
                <div class="weui-grid__icon">
            ...
            <a href="javascript:;" class="weui-grid" id="JiuZaiJuiZhi" <c:if test="${features.jiuZaiJuiZhi=='true'}">style="display:none"</c:if>>
                <div class="weui-grid__icon">
                    <img src="/static/images/minzheng/jiuzaijiuji.png" alt="">
                </div>
                <p class="weui-grid__label">救灾救济</p>
            </a>
            <a href="javascript:;" class="weui-grid" id="TeKunGongYang" <c:if test="${features.teKunGongYang=='true'}">style="display:none"</c:if>>
                <div class="weui-grid__icon">
