...
<div class="page__bd">
    ...
    <div class="weui-cells weui-cells_form">
        ...
        <div class="weui-grids">
            ...
            <a href="<%=basepath%>/microservice/placeSearch.jsp?xingqudian=4" class="weui-grid">
                <div class="weui-grid__icon">
