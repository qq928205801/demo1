...
<head>
    ...
    <script type="text/javascript" src="<%=basepath%>/js/common/Sortable.min.js"></script>
    <script type="text/javascript" src="<%=basepath%>/js/service/bigservice.js"></script>
    <script type="text/javascript" src="<%=basepath%>/js/navigation/navigation.js"></script>
</head>
<body ontouchstart>
<div class="page">
            ...
            <ul>
                <li>
                    <div class="weui-flex js_category">
                        <p class="weui-flex__item">丹溪路</p>
                        <img src="<%=basepath%>/images/icon_nav_form.png" alt="">
                    </div>
                    <div class="page__category js_categoryInner">
                        <div class="weui-cells page__category-content">
                            <a class="weui-cell weui-cell_access js_item" data-id="button" href="<%=basepath%>/a/a.jsp">
            ...
            <ul id="ashbin" style="display: none">
                <li>
                    <div class="weui-flex">
                        ...
                        <img  src="<%=basepath%>/images/icon_delete.png" alt="">
                    </div>
                    </li>
                </ul>
        </div>
                ...
                <li id="bigService_li_1">
                    ...
                    <div class="page__category js_categoryInner">
                        <div class="weui-grids page__category-content">
                            ...
                            <a href="<%=basepath%>/microservice/addmicroservice.jsp"  class="weui-grid">
                                <div class="weui-grid__icon">
                                    <img src="<%=basepath%>/images/plus_32px_581648_easyicon.net.png" alt="">
                                </div>
                ...
                <li id="bigService_li_2">
                    ...
                    <div class="page__category js_categoryInner">
                        <div class="weui-grids page__category-content">
                            ...
                            <a href="javascript:;" class="weui-grid">
                                <div class="weui-grid__icon">
                                    <img src="<%=basepath%>/images/minzheng/binzangguanli.png" alt="">
                                </div>
    ...
    <div class="weui-tabbar">
        ...
        <a class="weui-tabbar__item weui-bar__item_on" href="javascript:showqrcode();">
                <span style="display: inline-block;position: relative;">
                    <img src="<%=basepath%>/images/icon_nav_layout_1.png" alt="" class="weui-tabbar__icon">
        ...
        <a class="weui-tabbar__item weui-bar__item_on " href="javascript:showManagement();">
                <span style="display: inline-block;position: relative;">
                    <img src="<%=basepath%>/images/icon_nav_flow1.png" alt="" class="weui-tabbar__icon">
                    <span class="weui-badge weui-badge_dot"
                          style="position: absolute;top: 0;right: -6px;display: block"></span>
                </span>
        ...
        <a class="weui-tabbar__item weui-bar__item_on" href="javascript:showMonitoring();">
            <img src="<%=basepath%>/images/icon_nav_find.png" alt="" class="weui-tabbar__icon">
        ...
        <a class="weui-tabbar__item weui-bar__item_on" href="javascript:showFeedback();">
                <span style="display: inline-block;position: relative;">
                    <img src="<%=basepath%>/images/icon_nav_message.png" alt="" class="weui-tabbar__icon">
