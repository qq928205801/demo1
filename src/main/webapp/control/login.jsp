        ...
        <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
            ...
            <div class="block block-themed animated fadeIn">
                ...
                <div class="block-content block-content-full block-content-narrow">
                    <!-- Login Title -->
                    <h1 class="h2 font-w600 push-30-t push-5">智慧门牌管理系统</h1>
                    <p>请输入用户名和密码</p>
                    <!-- END Login Title -->
                    ...
                    <form class="js-validation-login form-horizontal push-30-t push-50"
                          action="${pageContext.request.contextPath}/control/login"
                          method="post">
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                <div class="form-material form-material-primary floating">
                                    ...
                                    <var id="checkUsernameAndPassword" style="color: red"></var>
                                </div>
                            </div>
                        </div>
...
<div class="push-10-t text-center animated fadeInUp">
    <small class="text-muted font-w600"><span class="js-year-copy"></span> &copy; 武汉一张图科技有限公司</small>
</div>
<!-- END Login Footer -->
...
<script type="text/javascript">
    ...
    function checkUsername() {
        ...
        if ($.trim(name).length == 0) {
            $("#checkUsernameAndPassword").html("用户名不能为空");
            return;
        }
        $("#checkUsernameAndPassword").html("");
    }

    function checkPassword() {
        var password = $("#login-password").val();
        if ($.trim(password).length == 0) {
            $("#checkUsernameAndPassword").html("密码不能为空");
            return;
        }
        $("#checkUsernameAndPassword").html("");
    }
