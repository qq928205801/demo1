                            ...
                            <div class="weui-grids page__category-content">
                                    ...
                                    <c:forEach items="${policeSystem}" var="systemList">
                                        <c:if test="${systemList.deptid==222}">
                                            ...
                                            <div class="weui-grid__icon" >
                                            <img src="${systemList.icon}" style="position:absolute;  z-index:1; width: 28px; height: 28px" alt="">
                                            <c:if test="${systemList.ifvalid=='0'}">
                                                <img src="/static/images/jinzhi3.png" style="position:absolute; z-index:2;width: 28px; height: 28px">
                                            </c:if>
                                            </div>
